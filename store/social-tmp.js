...
const actions = {
    ...
    try {
      ...
      if (result.success) {
        ...
        return new Promise((resolve) => {
          ...
          }, payload.post_image ? payload.post_image.length * 1000 : 0);
        });
      }
      return result;
    } catch (err) {
  ...
  async [actionTypes.SOCIAL.LIKE_COMMENT]({ state, commit }, { model = {}, postId } = {}) {
    try {
  ...
  async [actionTypes.SOCIAL.GET_CHILD_COMMENT]({ state, commit }, { source_id, parent_comment_id, page } = {}) {
    try {
      const result = await new Comment(this.$axios)[
  ...
  async [actionTypes.SOCIAL.DELETE_CHILD_COMMENT]({ state, commit }, { id, source_id, parent_comment_id } = {}) {
    try {
      const result = await new Comment(this.$axios)[
        actionTypes.BASE.DELETE_PAYLOAD
      ]({
  ...
  async [actionTypes.SOCIAL.LIKE_CHILD_COMMENT]({ state, commit }, { model = {}, postId, parentCommentId } = {}) {
    try {
      const result = await new Like(this.$axios)[actionTypes.BASE.ADD](model);
  ...
  async [actionTypes.SOCIAL.GET_COMMENT_DETAIL_POST]({ state, commit },
    payload
  ) {
    try {
      const result = await new Comment(this.$axios)[actionTypes.BASE.LIST]({
  ...
  async [actionTypes.SOCIAL.ADD_COMMENT_DETAIL_POST]({ state, commit },
    payload
  ) {
    try {
      const result = await new Comment(this.$axios)["postWithFormData"](
  ...
  async [actionTypes.SOCIAL.EDIT_COMMENT_DETAIL_POST]({ state, commit },
    payload
  ) {
    try {
      const result = await new Comment(this.$axios)[
  ...
  async [actionTypes.SOCIAL.DELETE_COMMENT_DETAIL_POST]({ state, commit }, { id } = {}) {
    try {
      const result = await new Comment(this.$axios)[
        actionTypes.BASE.DELETE_PAYLOAD
      ]({
  ...
  async [actionTypes.SOCIAL.LIKE_COMMENT_DETAIL_POST]({ state, commit }, { model = {} } = {}) {
    try {
      const result = await new Like(this.$axios)[actionTypes.BASE.ADD](model);
  ...
  async [actionTypes.SOCIAL.GET_CHILD_COMMENT_DETAI_POST]({ state, commit }, { parent_comment_id, page } = {}) {
    try {
      const result = await new Comment(this.$axios)[
        actionTypes.SOCIAL_COMMENTS.LIST_CHILDREN
      ]({
  ...
  async [actionTypes.SOCIAL.ADD_CHILD_COMMENT_DETAIL_POST]({ state, commit },
    payload
  ) {
    try {
      const result = await new Comment(this.$axios)[actionTypes.BASE.ADD](
  ...
  async [actionTypes.SOCIAL.EDIT_CHILD_COMMENT_DETAIL_POST]({ state, commit },
    payload
  ) {
    try {
      const result = await new Comment(this.$axios)["putWithFormData"](
  ...
  async [actionTypes.SOCIAL.DELETE_CHILD_COMMENT_DETAIL_POST]({ state, commit }, { id, parent_comment_id } = {}) {
    try {
      const result = await new Comment(this.$axios)[
        actionTypes.BASE.DELETE_PAYLOAD
      ]({
  ...
  async [actionTypes.SOCIAL.LIKE_CHILD_COMMENT_DETAIL_POST]({ state, commit }, { model = {}, parentCommentId } = {}) {
    try {
      const result = await new Like(this.$axios)[actionTypes.BASE.ADD](model);
