...
export const ELEARNING_PUBLIC_VOTED_ELEARNING = {
  SET_ELEARNING_PUBLIC_VOTED_ELEARNING_LIST:
    "setElearningPublicVotedElearningList",
};
...
export const TEACHING_OLCLASS_LESSON_ATTENDANCES = {
  SET_TEACHING_OLCLASS_LESSON_ATTENDANCES_LIST:
    "setTeachingOlclassLessonAttendancesList",
  SET_TEACHING_OLCLASS_LESSON_ATTENDANCES_EDIT:
    "setTeachingOlclassLessonAttendancesEdit",
  SET_TEACHING_OLCLASS_LESSON_ATTENDANCES_SUMMARY:
    "setTeachingOlclassLessonAttendancesSummary",
};

export const TEACHING_OLCLASS_LESSON_SESSIONS = {
  SET_TEACHING_OLCLASS_LESSON_SESSIONS_LIST:
    "setTeachingOlclassLessonSessionsList",
};
...
export const ELEARNING_TEACHING_EXERCISE_ELEARNING = {
  SET_TEACHING_EXERCISE_ELEARNING_LIST:
    "setElearningTeachingExerciseElearningList",
};
...
export const ELEARNING_TEACHING_EXERCISE_PARTICIAPANT = {
  SET_TEACHING_EXERCISE_PARTICIPANT_LIST:
    "setElearningTeachingExerciseParticipantList",
};
...
export const ELEARNING_CREATING_EXERCISES = {
  ...
  SET_ELEARNING_CREATING_EXERCISES_DELETE:
    "setElearningCreatingExercisesDelete",
};
...
export const ELEARNING_CREATING_QUESTIONS = {
  ...
  SET_ELEARNING_CREATING_QUESTIONS_DELETE:
    "setElearningCreatingQuestionsDelete",
};
