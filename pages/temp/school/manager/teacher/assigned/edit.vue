        ...
        <div class="box">
          <div class="school-manager__box">
            <div class="d-flex mb-4">
              <h6 class="color-red">Sửa Phân công giảng dạy (Năm học 2018-2019)</h6>
              <n-link :to="'/school/manager/teacher/assigned'" class="ml-auto">
                <IconClose class="fill-999" width="13" height="13" />
              </n-link>
            </div>
            <div class="school-manager__from-inline">
              <div class="row mb-4">
                <div class="col-md-3">
                  <span>Khối</span>
                </div>
              ...
              <div class="row">
                <div class="col-md-3">
                  <span>Các giáo viên bộ môn</span>
                </div>
                <div class="col-md-9">
                  <div>
                    <app-select
