    ...
    <div v-else class="container mt-6">
          ...
          <template slot-scope="{ classes }">
            ...
            >
              <ElearningHomeSubjectItem
                :title="item.name"
                :to="`/elearning/search?subject=${item.code}&subject_name=${item.name}&type=&sort=`"
              >
      ...
      <ElearningHomeBox>
        ...
        <n-link slot="title-right" 
          :to="`/elearning/search?subject=&subject_name=&type=lecture&sort=NEWEST`"
          class="link-readmore"
        >
          Xem thêm
      ...
      <ElearningHomeBox>
        ...
        <n-link slot="title-right" 
          :to="`/elearning/search?subject=&subject_name=&type=course&sort=NEWEST`"
          class="link-readmore">
          Xem thêm
          <IconArrowForwardIos class="icon fill-opacity-1 ml-2" />
        </n-link>
