        ...
        <div class="row">
            ...
            <div class="col-md-9">
                <ul class="school-nav">
                    ...
                    <li><a href >Cán bộ, giáo viên</a></li>
                    <li><a href >Quản lý thiết bị</a></li>
                    <li><a href >Quản lý Thư viện</a></li>
                    <li><a href >Quản lý văn thư</a></li>
                    <li><a href >Quản lý khoản thu</a></li>
                </ul>

                <SchoolAbout :school="school"/>

                <PostListSlider :posts="posts" :swiperOptions="sliderOptions" :showName="true" :title="'Tin tức'" class="slider-box"/>
            </div>
        </div>
        <div class="mt-6 school-list-slider">
            <AsideBox title="Các trường liên quan" class="link-underline" link="/school" linkText="Xem toàn bộ >>">
                <div class="row">
                    <div v-for="item in schools" class="col-3">
