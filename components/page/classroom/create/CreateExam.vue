  ...
  <div>
      ...
      <template v-slot:content>
        <div class="cc-panel__body">
          <app-alert type="warning" class="mb-4" show-close>
            ...
            Bạn có thể tạo bài kiểm tra bắt buộc cho bài giảng, khóa học của bạn tại đây. Học sinh cần hoàn thành bài
            kiểm tra và đạt điểm để hoàn thành khóa học.
          </app-alert>
    ...
    >
      <template v-slot:content>
        <div class="cc-panel__body">
          <div class="cc-box">
            <div class="ce-item cc-box__head d-flex align-items-center justify-content-between">
              <div class="ce-item__left d-flex align-items-center">
                <h3 class="body-2 mr-3">Bài tập 1</h3>
                <a href class="ce-item__action edit mr-3" @click.prevent="isEdited = !isEdited" title="Chỉnh sửa">
              ...
              <div class="ce-item__right">
                <a href class="text-secondary" @click.prevent="isEdited = !isEdited">Thêm câu hỏi</a>
              </div>
            </div>
            ...
            <div class="cc-box__body" v-if="isEdited">
              <div class="cc-box__bg-gray pa-4">
                ...
                <div v-if="editType === 'choice'">
                  ...
                  <div class="row mb-4">
                    <div class="col-md-3">
                      <label class="d-inline-block mb-3" for="">Điểm cho đáp án đúng</label>
                    </div>
                    <div class="col-md-2">
                      <app-input></app-input>
                    </div>
                ...
                <div v-if="editType === 'upload'">
                  <label class="d-inline-block mb-3" for="question-editor">Upload câu hỏi</label>
                  <div class="mb-4">
