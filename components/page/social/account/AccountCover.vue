<template>
  <div class="social-account__cover">
    <div class="sac__banner">
      <img :src="coverSrc" class="w-100"/>
    </div>
    <!--<app-upload class="cgi-upload-avt change-cover" @change="handleUploadCover">-->
      ...
      <!--</template>-->
    <!--</app-upload>-->
    <div class="sac__ava-wrapper">
      <div class="sac__avatar">
        <app-avatar :src="avatarSrc" :size="143" />
