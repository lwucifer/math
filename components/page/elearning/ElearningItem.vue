<template>
    <div class="elearning-item">
        ...
        <div class="content">
            ...
            <div class="d-flex">
                <span>Đã hoàn thành: </span><strong class="color-primary ml-2">{{data.status}}%</strong>
                <app-dropdown class="elearning-item__actions-menu ml-auto" align-content="right" open-on-click v-model="dropdownShow" content-width="230px">
                    ...
                    <ul class="elearning-item__actions-list">
                        ...
                        <li><a href="" class="d-flex">
                            <IconHeart/> <span>Thêm vào yêu thích</span>
                        </a></li>
                        <li><a href="" class="d-flex">
                            <IconSave/> <span>Lưu trữ</span>
                        </a></li>
                    </ul>
                </app-dropdown>
            </div>
